...
geth $opt --networkid=1719 --port=3210$node_id --nodiscover\
    --verbosity=4 --vmodule="p2p/*=0,core/state/*=0"\
 --datadir=$datadir --identity="node$node_id"  --rpc --rpcport=990$node_id > "$log_dir/$curdate.log" 2>&1  &
echo $!
